...
Fork personnel de [MonoCode](https://github.com/hardbeat920/monocode), maintenu via intégration validée de l'amont — version applicative **0.1.46**, distribution PK **2026.09.39**.
